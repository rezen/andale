...
mount:
  type: object
"""
def task(self, image=None, command=None, entrypoint=None, name=None, env={}, working_dir=None, files={}, mount={}):
    task_id = self.id
...
async def _record_output(workspace, cid, **kwargs):
    ...
    stream = container.log(stdout=('stdout' in kwargs), stderr=('stderr' in kwargs), logs=True, follow=True)
