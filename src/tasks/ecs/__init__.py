...
def task(self, name, payload, **kwargs):
    ...
    subnets = [
        "subnet-05a5xxxxxxxxxxx", 
        "subnet-0bc46xxxxxxxxxx"
    ]
    ...
    if started_tasks:
        ...
        for task in started_tasks:
            ...
            print("[i] Task https://{region}.console.aws.amazon.com/ecs/home?region={region}#/clusters/{cluster}/tasks/{task_id}/details".format(**{
                'task_id': task_id,
                'cluster': cluster,
                'region': region,
            }))
